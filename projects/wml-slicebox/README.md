...
updated package to conform with @windmillcode/angular-wml-components-base[](/Windmillcode-Angular-CDK-Docs/components/wml-select/)[](/Windmillcode-Angular-CDK-Docs/components/wml-table/)