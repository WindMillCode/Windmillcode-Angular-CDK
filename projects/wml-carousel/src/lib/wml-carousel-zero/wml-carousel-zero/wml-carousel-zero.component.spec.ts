...
import { WMLCarouselZeroComponent } from './wml-carousel-zero.component';


describe('WMLCarouselZeroComponent', () => {
  let cpnt: WMLCarouselZeroComponent;
  let fixture: ComponentFixture<WMLCarouselZeroComponent>;
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('WMLCarouselZeroView ')
    })
