...
This content is for the 18.2.3100 version. Switch to the[latest version](/Windmillcode-Angular-CDK-Docs/components/wml-mobile-nav/)for up-to-date documentation.
...
updated package to reflect the version  18.2.4 of @angular/core package[](/Windmillcode-Angular-CDK-Docs/18.2.3100/components/wml-input/)[](/Windmillcode-Angular-CDK-Docs/18.2.3100/components/wml-notify/)