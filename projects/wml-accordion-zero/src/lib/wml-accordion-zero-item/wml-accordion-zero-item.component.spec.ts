...
import { WMLAccordionZeroItemComponent, WMLAccordionZeroItemParams } from './wml-accordion-zero-item.component';
  ...
  describe("ngOnInit",()=>{
    ...
    does the required action `,()=>{
      ...
      expect(wmlComponetsBase.addCustomComponent ).toHaveBeenCalledWith(
        ...
        cpnt.params.accordionBody.cpnt,
        cpnt.params.accordionBody.params
      )
    ...
    it(` when called |
    and (!this.params.isClosed) === true |
    does the required action `,()=>{
      // arrange
      let id
      cpnt.params.id = id = "id"
      cpnt.params.isClosed = false
      // act
      cpnt.ngOnInit()
      // assert
      expect(cpnt.myId).toEqual(id)
  ...
  describe("toggleAccordion",()=>{
    describe("val",()=>{
      ...
      does the required action `,()=>{
        ...
        expect(cpnt.cdref.detectChanges).toHaveBeenCalled()
        expect(cpnt.params.isClosed).toEqual(val)
...
describe("WMLAccordionZeroItemParams",()=>{
  let cpnt:WMLAccordionZeroItemParams
  beforeEach(()=>{
    cpnt = new WMLAccordionZeroItemParams()
  })
  describe("init", () => {
