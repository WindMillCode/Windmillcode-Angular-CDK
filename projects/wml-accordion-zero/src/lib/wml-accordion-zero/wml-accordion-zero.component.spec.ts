...
import { WMLAccordionZeroComponent, WMLAccordionZeroParams } from './wml-accordion-zero.component';
...
describe("WMLAccordionZeroParams",()=>{

  let helper:WMLAccordionZeroParams
  beforeEach(()=>{
    helper = new WMLAccordionZeroParams()
  })
  describe("init",()=>{
    it("should create", () => {
    ...
    it("should have all properties be the correct class instance", () => {
      ...
      .forEach((group)=>{
        group.forEach((item)=>{
          expect(item).toBeInstanceOf(WMLAccordionZeroItemParams)
        })
      })
    })
  })
