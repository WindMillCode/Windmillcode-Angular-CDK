...
describe('WmlInputComponent', () => {
  ...
  beforeEach(async () => {
    await wmlTestUtils.configureTestingModuleForComponents(WmlInputComponent,{mockTranslateService});
    ({fixture, cpnt} = wmlTestUtils.grabComponentInstance(WmlInputComponent));
