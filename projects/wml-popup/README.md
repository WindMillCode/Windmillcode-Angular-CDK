...
updated package to conform with @windmillcode/angular-wml-components-base[](/Windmillcode-Angular-CDK-Docs/components/wml-panel/)[](/Windmillcode-Angular-CDK-Docs/components/wml-select/)