...
v0.1.7uploadAllowedPredicate - allows developer to edit the files list after the uploadAllowedPredicate validation for additional modfication or aux tasks as needed
...
updated package to reflect the version  18.2.8 of @angular/core package[](/Windmillcode-Angular-CDK-Docs/angular-components/wml-field/)[](/Windmillcode-Angular-CDK-Docs/angular-components/wml-form/)