...
import { WmlOptionItemComponent } from './wml-option-item.component';
import { ViewContainerRef } from '@angular/core';
let wmlComponentsBase = require("@windmillcode/angular-wml-components-base")

describe('WmlOptionItemComponent', () => {
  let cpnt: WmlOptionItemComponent;
  let fixture: ComponentFixture<WmlOptionItemComponent>;
  ...
  beforeEach(async () => {
    ...
    await wmlTestUtils.configureTestingModuleForComponents(WmlOptionItemComponent);
    ({fixture, cpnt} =  wmlTestUtils.grabComponentInstance(WmlOptionItemComponent));
    cpnt.params.customCpnt.cpnt = MockWmlSampleOptionItemComponent
  ...
  describe("ngOnInit",()=>{
    ...
    does the required action `,()=>{
      ...
      expect(wmlComponentsBase.addCustomComponent).toHaveBeenCalledWith(
        cpnt.customOption,
        cpnt.params.customCpnt.cpnt,
        cpnt.params.customCpnt.params
      )
